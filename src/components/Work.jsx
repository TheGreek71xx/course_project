...
import WorkImg from '../assests/WorkImg'
import realEstate from '../assests/realEstate'
        ...
        <div className= 'w-full md:h-screen text-gray-300 bg-[#0a192f]'>
            <div className='max-w-[100px] mx-auto p-4 flex flex-col justify-center w-full h-full'>>
                <div className='pb-8'>
                    ...
                    <p className='py-6'>// Feel free to tae a look on some of the projects 
                        and things we've helped out with in the past.</p>
                </div>
                {/* Grid Image */}
            <div 
